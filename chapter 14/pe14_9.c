...
int main(void)
{
    ...
    for (j=0; j<4; j++)
        ...
        if ((wp=fopen("miejsca2.dat", "rb"))==NULL)
    {
    ...
    while ((rejs = menu2())!='e')
    {
        ...
        while ((wybor = menu(nr_rejs))!='f')
            ...
            {
            case 'a':
                liczba_miejsc(nr_rejs);
                break;
            case 'b':
                lista_miejsc(nr_rejs);
                break;
            case 'c':
                lista_alfabetyczna(nr_rejs);
                break;
            case 'd':
                klient(nr_rejs);
                break;
            case 'e':
                usun_miejsce(nr_rejs);
                break;
            }
    }
    if ((wp=fopen("miejsca2.dat", "wb"))==NULL)
